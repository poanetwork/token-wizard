...
import { TierSetupWhitelistWithCap } from '../../../src/components/StepFour/TierSetupWhitelistWithCap'
import { tierStore } from '../../../src/stores'
import { defaultTier, defaultTierValidations } from '../../../src/utils/constants'

configure({ adapter: new Adapter() })

describe('TierSetupWhitelistWithCap', () => {
  it(`should render the component `, () => {
    ...
    const wrapper = shallow(<TierSetupWhitelistWithCap {...stores} />)
