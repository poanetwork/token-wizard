...
import { CrowdsaleSetupBlockDutchAuction } from '../../../src/components/StepFour/CrowdsaleSetupBlockDutchAuction'
import { tierStore } from '../../../src/stores'
import { defaultTier, defaultTierValidations } from '../../../src/utils/constants'

configure({ adapter: new Adapter() })

describe('CrowdsalSetupBlockDutchAuction', () => {
  it(`should render the component `, () => {
    ...
    const wrapper = shallow(<CrowdsaleSetupBlockDutchAuction {...stores} />)
