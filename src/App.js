...
import { Header, Footer, Home, Contracts, stepOne, stepTwo, stepThree, stepFour, Crowdsale, Invest } from './components/index'
    ...
    return (
      <Router>
        <div>
          ...
          <Route exact path="/crowdsaleDetails/:addr" component={Contracts}/>
