...
import { Header, Footer, Home, crowdsaleDetails, stepOne, stepTwo, stepThree, stepFour, Crowdsale, Invest } from './components/index'
    ...
    return (
      <Router>
        <div>
          ...
          <Route exact path="/crowdsaleDetails/:addr" component={crowdsaleDetails}/>
