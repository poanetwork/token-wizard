      ...
      <section className="steps steps_publish">
        ...
        <div className="steps-content container">
          ...
          <div className="hidden">
            ...
            <div className="hidden">
              <DisplayField side='left' title={'Start block'} value={this.state.crowdsale.startBlock?this.state.crowdsale.startBlock:""}/>
              <DisplayField side='right' title={'End block'} value={this.state.crowdsale.endBlock?this.state.crowdsale.endBlock:""}/>
