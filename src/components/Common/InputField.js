...
export class InputField extends React.Component {
	...
	render() {
		...
		return (<div className={this.props.side}>
			...
			<input ref={this.props.ref} disabled={this.props.disabled} type={this.props.type} className="input" onBlur={this.props.onBlur} value={this.props.val} defaultValue={this.props.defaultValue} onChange={this.onChange}/>
