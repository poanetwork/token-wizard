...
export const WhitelistItem = ({isLast, addr, min, max}) => {
	return <div className={isLast?"white-list-item-container white-list-item-container-last":"white-list-item-container"}><div className="white-list-item-container-inner">
            ...
            <div className="white-list-item-empty"></div>
            </div>
}