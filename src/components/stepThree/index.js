            ...
            render={({ handleSubmit, values, invalid, errors }) => {
              return (
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="steps-content container">
                      ...
                      <div className="input-block-container">
                        ...
                        <Field
                          ...
                          side="right"
                          label="Gas price"
                          validate={value => (value && value > 0) ? undefined : 'Required field'}
                      ...
                      <div className="input-block-container">
                        <Field
                          ...
                          side="left"
                          label={MINCAP}
                          validate={value => (value >= 0) ? undefined : 'Required field'}
                      ...
                      <div>
                        {fields.map((name, index) => (
                          <div style={{ marginTop: '40px' }} className='steps-content container' key={index}>
                            ...
                            <label>
                              Rate
                              <Field name={`${name}.rate`} component="input" type="number" />
                            </label>
                            <br />

                            <label>
                              Supply
                              <Field name={`${name}.supply`} component="input" type="number" />
                            </label>
                            <br />
                  ...
                  <button type="submit" disabled={invalid}>Next</button>
